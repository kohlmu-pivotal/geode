 ...
 */
package org.apache.geode.org.apache.geode.memcached;
...
public class MemcacheComponentManagementService implements ComponentManagementService {
  @Override
  public boolean canCreateComponent(ComponentIdentifier componentIdentifier) {
    return componentIdentifier.getComponentName().equals("MEMCACHED");
  }

  @Override
  public ServiceResult<Boolean> init(ModuleService moduleService, Object[] args) {
    System.err.println("Initialized Memcached ComponentManagementService");
