 ...
 */
package org.apache.geode.internal.modules.service;
...
import org.apache.geode.internal.modules.loader.GeodeModuleLoader;

/**
 * This class is essentially a wrapper around {@link GeodeModuleLoader} that is used to load and
 * unload modules at runtime.
 */
public class GeodeJBossDeploymentService {

  private static final GeodeModuleLoader geodeModuleLoader =
      (GeodeModuleLoader) Module.getBootModuleLoader();
  private final String customJarDeploymentModuleName = "geode-custom-jar-deployments";
  ...
  public boolean unregisterModule(String moduleName) {
    try {
      geodeModuleLoader.unregisterModuleDependencyFromModule(moduleName);
