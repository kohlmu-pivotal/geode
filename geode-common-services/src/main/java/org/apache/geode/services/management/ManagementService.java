...
public interface ManagementService {
  ...
  ServiceResult<Boolean> createApp(String appName, BootstrappingService bootstrappingService);

  ServiceResult<Boolean> destroyApp(String appName);
   ...
   */
  ServiceResult<Boolean> createComponent(String appName, String instanceName,
      ComponentIdentifier componentIdentifier, Object... args);
   ...
   *         failure.
   */
  ServiceResult<Boolean> closeComponent(String appName, String instanceName,
      ComponentIdentifier componentIdentifier, Object... args);
}
